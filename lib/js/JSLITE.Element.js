...
JSLITE.apply(JSLITE.Element, {
   ...
   * @example
    ...
    */
    ...
    //<source>
    fly: function (vElem) {
        if (!this.flyweight[JSLITE.globalSymbol]) {
          this.flyweight[JSLITE.globalSymbol] = new JSLITE.Element();
        }
        this.flyweight[JSLITE.globalSymbol].dom = JSLITE.dom.getDom(vElem);
        return this.flyweight[JSLITE.globalSymbol];
